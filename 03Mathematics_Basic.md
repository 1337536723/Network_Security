...
- （M7） 乘法逆元： 对于F中除0以外的任意元素a, G中存在逆元 <img src="http://latex.codecogs.com/gif.latex?a^{-1}" />  使得 <img src="http://latex.codecogs.com/gif.latex?aa^{-1} = a^{-1}a = 1" /> 。
...
####　核心： <img src="http://latex.codecogs.com/gif.latex?gcd(a,b)=gcd(b, a \mod b)" />
